...
public class InputData {
	...
	public InputData(int iPerson) {			// 정수형태인 k07_iperson을 인자로 하는 k07_InputData 메서드를 만들어준다.
	...
	public void InputData(int i, String name, int kor, int eng, int math) {	// 번호,이름,국어점수,영어점수,수학 점수를 인자로 받고 각 배열에 넣어준다.
